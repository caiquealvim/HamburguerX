...
import Casal from "@/public/images/casalPastor.jpeg"
...
const Footer = () => {
  return (
    <div  data-aos="fade-right"  data-aos-duration="800" className=' pt-[rem] pb-[3rem]  bg-green-900 opacity-90' id='footer' >
        ...
        grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem] items-center justify-center'>
            ...
            <div className='w-[80%] text-center flex flex-col gap-2 text-white items-center mx-auto mt-6'>
            ...
            <div className=' text-center flex flex-col gap-2 text-white'>
                 <h2 className='text-[30px]'>Pastores Presidentes!</h2>
                <Image src={Casal} alt='igreja' width={600} height={400} className=' rounded-xl'/>
            </div>
