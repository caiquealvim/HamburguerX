  ...
  return (
    <div data-aos="fade-up"  data-aos-duration="1000"  id='pix' className='pt-[5rem] pb-[5rem] bg-gradient-to-r from-lime-900 to-gray-800 text-white '>
        <div className='text-center' data-aos="zoom-out-right"  data-aos-duration="2000">
            ...
            Viu também uma viuva pobre colocar duas pequeninas moedas de cobre. E disse
            Afirmo que esta viuva pobre colocou mais do que todos os outros. Todos esses deram do que lhes sobrava,
            mas ela, da sua pobreza, deu tudo o que possuía para viver.
            Lucas 21 1-4
            </p>
